...
$records=mysql_query($sql);
  ...
  <!DOCTYPE html>
    ...
    <head>
    	...
    	<meta name="description" content="Fife College Foundation - Applications">
    ...
    <img class="indexlogo animated fadeIn img-responsive center-block" src=" ../assets/img/logo.png" width="13%;" alt="Logo" style="margin-top: 20px;">
...
while($applicant=@mysql_fetch_assoc($records)) {
  ...
  echo '<div data-aos="fade-up" style="padding: 35px; margin-bottom: 50px;-webkit-box-shadow: 1px 1px 5px 0px rgba(50, 50, 50, 0.75); -moz-box-shadow:    1px 1px 5px 0px rgba(50, 50, 50, 0.75); box-shadow:         1px 1px 5px 0px rgba(50, 50, 50, 0.75);"';
  echo '<p><b>Applicant Number:</b> ' . $applicant['id'] . '</p>';
  echo '<p><b>Name:</b> ' . $applicant['name'] . '</p>';
  echo '<p><b>Email:</b> ' . $applicant['email'] . '</p>';
  echo '<p><b>Contact Number:</b> ' . $applicant['phone'] . '</p>';
