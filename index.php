...
<head>
	...
	<link rel="mask-icon" href="/safari-pinned-tab.svg" color="#11596e">
	...
	<nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
		...
		<div class="container-fluid">
          ...
          <span class="icon-bar"></span>
				...
				<!-- Navbar logo starts -->
				<a class="navbar-brand" href="/"><img alt="Logo" data-aos="fade-in" src="assets/img/logo.png"></a>
				<!-- Navbar logo ends -->
			</div>
		</div>
							...
							<div class="modal-body">
								...
								<div class="form-area" style="box-shadow: none;">
									<form action="apply.php" method="post">
										...
										<div class="form-group">
											<textarea class="form-control" type="textarea" id="message" name="message" placeholder="Message*" maxlength="9000" rows="7"></textarea>
										</div>

										<input type="submit" id="submit" value="Submit" name="submit" class="btn btn-primary center-block" style="border-radius:0px;background-color:#7f8c8d;border:none;-webkit-box-shadow: 1px 1px 5px 0px rgba(50, 50, 50, 0.75);
	...
	<div class="footer-area">
		<div class="container">
			<div class="col-md-12">
				...
				<p class="footertext">If you prefer to contact us directly please email: foundationenquiries@gmail.com</p>
